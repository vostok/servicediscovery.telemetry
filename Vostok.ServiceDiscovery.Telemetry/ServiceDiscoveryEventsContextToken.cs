...
{
    /// <summary>
    /// <para>Creating an instance of <see cref="ServiceDiscoveryEventsContextToken"/> sets a new global value of <see cref="IServiceDiscoveryEventsBuilder"/>
    ...
    /// </summary>
    [PublicAPI]
    public class ServiceDiscoveryEventsContextToken : IDisposable
    {
        ...
        /// </summary>
        public ServiceDiscoveryEventsContextToken([NotNull] Action<IServiceDiscoveryEventsBuilder> setup)
        {
